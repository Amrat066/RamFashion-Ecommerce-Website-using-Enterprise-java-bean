...
@NamedQueries({
    ...
    @NamedQuery(name = "GroupTable.findByPass", query = "SELECT g FROM GroupTable g WHERE g.pass = :pass"),
...
public class GroupTable implements Serializable {
    ...
    public GroupTable(Integer id, String username, String pass, String email, String address, String city, String state, String phone, String role) {
        this.id = id;
